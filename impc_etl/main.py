...
from impc_etl.jobs.extraction.dcc_extractor import extract_samples, extract_experiment_files
...
def main():
    ...
    if os.path.exists('../tests/data/impress_parquet'):
        ...
        impress_df.write.parquet("../tests/data/impress_parquet")
    ...
    samples_df.count()
    experiments_df = extract_experiment_files(spark, '/Users/federico/data/*experiment.xml')
    experiments_df.printSchema()
    experiments_df.count()
