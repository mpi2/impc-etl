...
class ImpcKgMouseAlleleMapper(PySparkTask):
    ...
    #: Name of the Spark task
    name: str = "ImpcKgMouseAlleleMapper"

    #: Path of the output directory where the new parquet file will be generated.
    output_path: luigi.Parameter = luigi.Parameter()

    def requires(self):
        return [ExtractAlleleRef()]
    ...
    def output(self):
        ...
        (e.g. impc/dr15.2/parquet/product_report_parquet)
        """
        return ImpcConfig().get_target(f"{self.output_path}/impc_kg/mouse_allele_json")
    ...
    def main(self, sc: SparkContext, *args):
        ...
        # Parsing app options
        allele_ref_parquet_path = args[0]
        output_path = args[1]
...
class ImpcKgPublicationsMapper(PySparkTask):
    ...
    def main(self, sc: SparkContext, *args):
        ...
        publications_df = _add_unique_id(
            publications_df,
            "publication_id",
            ["pmId"],
        )

        publications_df = _map_unique_ids(
