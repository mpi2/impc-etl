...
class GeneProductionStatusExtractor(PySparkTask):
    ...
    __________
        ...
        imits_gene_status_path: luigi.Parameter
            Path in the filesystem (local or HDFS) to the IMITS gene status report
    ...
    def _resolve_assigment_status(self, gene_status_df: DataFrame) -> DataFrame:
        """

        :param gene_status_df:
        :return:
        """
        gene_status_df = gene_status_df.withColumn(
            "assignment_status",
    ...
    def _create_status_map(
        self, spark: SparkSession, status_map_dict: Dict
    ) -> DataFrame:
