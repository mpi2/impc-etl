...
from impc_etl.jobs.extract.static_data_extractor import (
...
def test_extract_phenotyping_centres_info():
    ...
    session_mock.read.csv.assert_called_with(
        "some/path", header=True, mode="DROPMALFORMED", schema=None, sep="\t"
    )
